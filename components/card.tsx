...
const Card = ({ title, text, text2, image, onClick }) => {
  return (
    <div className="flex">
      <div className="w-80 h-56 p-6 flex flex-col justify-between bg-white/10 backdrop-blur-3xl backdrop-saturate-150 rounded-2xl border border-white/20 shadow-lg shadow-white/10">
        {image && (
          <img
            src={image}
            alt={title}
